...
def candidate_model_v14_england_irs(
    data, ep, r_walk_noise_scale_period=7, ir_walk_noise_scale_period=14, **kwargs
):
    alpha_i = numpyro.sample(
        "alpha_i",
...
def candidate_model_v14_alt_ifr_prior(
    data, ep, r_walk_noise_scale_period=7, ir_walk_noise_scale_period=14, **kwargs
):
    alpha_i = numpyro.sample(
        "alpha_i",
    ...
    iar_0 = 1.0
    ifr_0 = numpyro.sample(
        "ifr_0", dist.TruncatedNormal(low=1e-2, loc=0.05, scale=0.005)
    )
...
def candidate_model_v14_ppool_variable(
    data, ep, r_walk_noise_scale_period=7, ir_walk_noise_scale_period=14, **kwargs
):
    alpha_i = numpyro.sample(
        "alpha_i",
    ...
    sigma_i = numpyro.sample(
        "sigma_i", dist.HalfNormal(jnp.sqrt((0.15 ** 2) / data.nCMs))
    )
...
def candidate_model_v14_ppool_fixed(
    data, ep, r_walk_noise_scale_period=7, ir_walk_noise_scale_period=14, **kwargs
):
    alpha_i = numpyro.sample(
        "alpha_i",
...
def candidate_model_v14_fixed_ir(
    data, ep, r_walk_noise_scale_period=7, ir_walk_noise_scale_period=14, **kwargs
):
    alpha_i = numpyro.sample(
        "alpha_i",
...
def candidate_model_v14_fixed_ir_scale(
    data,
    ep,
    r_walk_noise_scale_period=7,
    ir_walk_noise_scale_period=14,
    iar_noise_scale=0.01,
    **kwargs,
):
    alpha_i = numpyro.sample(
        "alpha_i",
    ...
    iar_noise_scale = iar_noise_scale
