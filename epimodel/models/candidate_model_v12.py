...
def candidate_model_v12_hypothesis(
    data,
    ep,
...
def candidate_model_v12_hypothesis_v2(
    data,
    ep,
    iar_noisescale_prior=None,
    r_walk_noise_scale_period=7,
...
def candidate_model_v12_hypothesis_v2b(
    data,
    ep,
    iar_noisescale_prior=None,
    r_walk_noise_scale_period=7,
    ...
    **kwargs
    ...
    init_infections = jax.ops.index_add(
        init_infections,
        jax.ops.index[:, -seeding_padding:],
        jnp.repeat(seeding**3., seeding_padding, axis=-1),
    )
...
def candidate_model_v12_hypothesis_v3_no_rescale(
    data,
    ep,
    iar_noisescale_prior=None,
    r_walk_noise_scale_period=7,
    ...
    **kwargs
    ...
    # another rescaled parameter!
    alpha_i_tilde = numpyro.sample(
        "alpha_i_tilde", AsymmetricLaplace(asymmetry=0.5 * jnp.ones(data.nCMs), scale=40)
    )
    alpha_i = numpyro.deterministic("alpha_i", alpha_i_tilde)
...
def candidate_model_v12_hypothesis_v3_rescale(
    data,
    ep,
    iar_noisescale_prior=None,
    r_walk_noise_scale_period=7,
    ...
    **kwargs
    ...
    # another rescaled parameter!
    alpha_i_tilde = numpyro.sample(
        "alpha_i_tilde", AsymmetricLaplace(asymmetry=0.5 * jnp.ones(data.nCMs), scale=40/3.3)
    )
    alpha_i = numpyro.deterministic("alpha_i", alpha_i_tilde/3.3)
...
def candidate_model_v12_hypothesis_v3_less_npis(
    data,
    ep,
    iar_noisescale_prior=None,
    r_walk_noise_scale_period=7,
    ...
    **kwargs
    ...
    # another rescaled parameter!
    alpha_i_tilde = numpyro.sample(
        "alpha_i_tilde", AsymmetricLaplace(asymmetry=0.5 * jnp.ones(12), scale=40)
    )
    alpha_i = numpyro.deterministic("alpha_i", alpha_i_tilde)

    # no more partial pooling
    cm_reduction = jnp.sum(data.active_cms[:, :12, :] * alpha_i.reshape((1, 12, 1)), axis=1)
...
def candidate_model_v12_hypothesis_v3_normal(
    data,
    ep,
    iar_noisescale_prior=None,
    r_walk_noise_scale_period=7,
    ...
    **kwargs
    ...
    alpha_i = numpyro.sample(
        "alpha_i", dist.Normal(loc=jnp.zeros((data.nCMs)), scale=0.1)
    )
