...
def candidate_model_v7_fixed_r_var(
    data,
    ep,
    iar_noisescale_prior=None,
    r_walk_noise_scale_period=7,
...
def candidate_model_v7_fixed_ir_scale(
    data,
    ep,
    iar_noisescale_prior=None,
    r_walk_noise_scale_period=7,
...
def candidate_model_v7_centered_ir_noise(
    data,
    ep,
    iar_noisescale_prior=None,
    r_walk_noise_scale_period=7,
...
def candidate_model_v7_centered_inf_noise(
    data,
    ep,
    iar_noisescale_prior=None,
    r_walk_noise_scale_period=7,
    ...
    **kwargs
    ...
    infection_noise = numpyro.sample(
        "infection_noise",
        dist.Normal(loc=jnp.zeros((data.nRs, data.nDs)), scale=infection_noise_scale),
    )

    # enforce positivity!
    infections = jax.nn.softplus(infections + (infection_noise.T))
...
def candidate_model_v7_fixed_inf_noise(
    data,
    ep,
    iar_noisescale_prior=None,
    r_walk_noise_scale_period=7,
...
def candidate_model_v7_no_inf_noise(
    data,
    ep,
    iar_noisescale_prior=None,
    r_walk_noise_scale_period=7,
...
def candidate_model_v7_relu(
    ...
    **kwargs
    ...
    # enforce positivity!
    infections = jax.nn.relu(infections + (infection_noise_scale * infection_noise.T))
...
def candidate_model_v7_weekly_inf_noise(
    data,
    ep,
    iar_noisescale_prior=None,
    r_walk_noise_scale_period=7,
...
def candidate_model_v7_alt_conv(
    data,
    ep,
    iar_noisescale_prior=None,
    r_walk_noise_scale_period=7,
