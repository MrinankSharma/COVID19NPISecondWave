...
argparser.add_argument(
    ...
    dest="output_noise_scale_prior",
    type=float,
    help="Output_noise_scale_prior",
)
...
if __name__ == "__main__":
    ...
    model_build_dict["output_noise_scale_prior"] = args.output_noise_scale_prior
    ...
    info_dict["exp_config"] = {
        "output_noise_scale_prior": args.output_noise_scale_prior
    }
